...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/test/test/">保存成功列表</a></li>
		<li class="active"><a href="${ctx}/test/test/form?id=${test.id}">保存成功<shiro:hasPermission name="test:test:edit">${not empty test.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="test:test:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
